	<header>
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<a class="nav-link stock">
					<span class="bd-font grey3">AGRO</span> <i class="fas fa-angle-up alt-green2"></i> <span class="al	t-green2">8.22 (+0.86%)</span>
				</a>
		...
		<ul id="submenu1" class="sub bg-light text-center desktop-only">
			<li class="active"><a href="index.php?s=strategy">Strategy</a></li><li><a href="#">Organizational Structure</a></li><li><a href="#">Board of Directors</a></li><li><a href="#">Executive Officers</a></li><li><a href="#">Dividend policy</a></li><li><a href="#">Bylaws</a></li><li><a href="#">Code of Ethics</a></li><li><a href="#">Insider Trading Policy</a></li><li><a href="#">Annual General Meeting</a></li>
		</ul>
